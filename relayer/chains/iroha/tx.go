...
func (c *Chain) TxCreateClient(opts *bind.TransactOpts, msg *clienttypes.MsgCreateClient) (*Transaction, error) {
...
func (c *Chain) TxUpdateClient(opts *bind.TransactOpts, msg *clienttypes.MsgUpdateClient) (*Transaction, error) {
...
func (c *Chain) TxConnectionOpenInit(opts *bind.TransactOpts, msg *conntypes.MsgConnectionOpenInit) (*Transaction, error) {
	return c.ibcHandler.Transact(
		opts,
		"connectionOpenInit",
...
func (c *Chain) TxConnectionOpenTry(opts *bind.TransactOpts, msg *conntypes.MsgConnectionOpenTry) (*Transaction, error) {
	clientStateBytes, err := proto.Marshal(msg.ClientState)
	if err != nil {
		return nil, err
	}
...
func (c *Chain) TxConnectionOpenAck(opts *bind.TransactOpts, msg *conntypes.MsgConnectionOpenAck) (*Transaction, error) {
	clientStateBytes, err := proto.Marshal(msg.ClientState)
	if err != nil {
		return nil, err
	}
...
func (c *Chain) TxConnectionOpenConfirm(opts *bind.TransactOpts, msg *conntypes.MsgConnectionOpenConfirm) (*Transaction, error) {
	return c.ibcHandler.Transact(
		opts,
...
func (c *Chain) TxChannelOpenInit(opts *bind.TransactOpts, msg *chantypes.MsgChannelOpenInit) (*Transaction, error) {
	return c.ibcHandler.Transact(
		opts,
		"channelOpenInit",
...
func (c *Chain) TxChannelOpenTry(opts *bind.TransactOpts, msg *chantypes.MsgChannelOpenTry) (*Transaction, error) {
	return c.ibcHandler.Transact(
		opts,
		"channelOpenTry",
...
func (c *Chain) TxChannelOpenAck(opts *bind.TransactOpts, msg *chantypes.MsgChannelOpenAck) (*Transaction, error) {
	return c.ibcHandler.Transact(
		opts,
		"channelOpenAck",
...
func (c *Chain) TxChannelOpenConfirm(opts *bind.TransactOpts, msg *chantypes.MsgChannelOpenConfirm) (*Transaction, error) {
	return c.ibcHandler.Transact(
		opts,
		"channelOpenConfirm",
...
func (c *Chain) TxRecvPacket(opts *bind.TransactOpts, msg *chantypes.MsgRecvPacket) (*Transaction, error) {
	return c.ibcHandler.Transact(
		opts,
		"recvPacket",
...
func (c *Chain) TxAcknowledgement(opts *bind.TransactOpts, msg *chantypes.MsgAcknowledgement) (*Transaction, error) {
	return c.ibcHandler.Transact(
		opts,
		"acknowledgePacket",
...
func (chain *Chain) TxSync(ctx context.Context, tx *Transaction) error {
	var receipt *gethtypes.Receipt
	err := retry.Do(
		func() error {
			rc, err := chain.client.TransactionReceipt(ctx, tx.ID)
			if err != nil {
				return err
			}
			receipt = rc
...
func (chain *Chain) TxSyncIfNoError(ctx context.Context) func(tx *Transaction, err error) error {
	return func(tx *Transaction, err error) error {
		if err != nil {
			return err
		}
